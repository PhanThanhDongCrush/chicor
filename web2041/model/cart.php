...
function insert_hoa_don_chi_tiet($name, $email, $address, $tel, $pttt, $ngaydathang, $tongdonhang)
{
    $sql = "insert into hoa_don_chi_tiet(ten_kh,email,dia_chi,sdt,pttt,ngay_dat,tong_tien) values('$name','$email','$address','$tel','$pttt','$ngaydathang','$tongdonhang')";
...
{
    $sql = "select * from hoa_don where ma_hdct like " . $ma_hdct;
    $bill = pdo_query($sql);
    return $bill;
}
